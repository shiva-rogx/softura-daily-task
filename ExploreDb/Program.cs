...
namespace ExploreDb
{
    class Program
    {
        public void SelectBooks_Authors()
        {
            ...
            SqlConnection con = new SqlConnection(@"data source=LAPTOP-8J9PFGLH;database=DbBooks;Integrated Security=true"); SqlCommand cmd = new SqlCommand("select * from tbl_Books b join tbl_author a on a.AuthorId=b.AuthorId", con);
            con.Open();
        ...
        {
            SqlConnection con = new SqlConnection(@"data source=LAPTOP-8J9PFGLH;database=DbBooks;Integrated Security=true"); SqlCommand cmd = new SqlCommand("insert into tbl_author values('Rajeev Bhatt')", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        {
            SqlConnection con = new SqlConnection(@"data source=LAPTOP-8J9PFGLH;database=DbBooks;Integrated Security=true"); SqlCommand cmd = new SqlCommand("DELETE FROM tbl_author WHERE AuthorId=109", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        {
            SqlConnection con = new SqlConnection(@"data source=LAPTOP-8J9PFGLH;database=DbBooks;Integrated Security=true"); SqlCommand cmd = new SqlCommand();
        ...
        {
            string res = null;
            SqlConnection con = new SqlConnection(@"data source = LAPTOP-8J9PFGLH; database = DbBooks; Integrated Security = true");
